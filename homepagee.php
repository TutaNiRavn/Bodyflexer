...
<!--Login-->
    <div class="container">
        <div class="homepage-design">
            ...
            <a href="program.php" class="btn">Explore Now &#8594;</a>
        </div>
    </div>
