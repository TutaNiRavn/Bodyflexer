            ...
            <div class="checklist-container">
                ...
                <ul class="checklist">
                    <li>
                        ...
                        <a href="../push-pull/day4.php">DAY 4</a>
                    </li>
                    <li>
                        <input type="checkbox" id="rest5">
                        <label for="rest5"></label>
                        <a href="../push-pull/day5.php">DAY 5</a>
                    </li>
                    <li>
                        <input type="checkbox" id="rest6">
                        <label for="rest6"></label>
                        <a href="../push-pull/day6.php">DAY 6</a>
                    </li>
                </ul>
            </div>
        </div>
